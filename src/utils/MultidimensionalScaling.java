 ...
 *
 */
interface IntMetricSpace {
    public double distance(int i, int j);
}

interface IntFiniteMetricSpace extends IntMetricSpace {
    public int size();
}

class AbstractIntMetricSpace implements IntFiniteMetricSpace {
    private final double[][] distanceMatrix;
    public AbstractIntMetricSpace(double[][] distanceMatrix) {
...
*/
	...
	*/
	...
	public static void main(String[] args) {
		...
		MultidimensionalScaling mds = MultidimensionalScaling.getInstance();
		//mds.distanceMatrix = D;
		
		AbstractIntMetricSpace matrix = new AbstractIntMetricSpace(null);
		
		DoubleMatrix2D res = mds.doScaling(matrix, 0, TOLERANCE);
